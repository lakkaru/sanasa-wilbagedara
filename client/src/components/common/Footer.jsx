          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-sanasa-blue-600 transition-colors"
                aria-label="Facebook"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-sanasa-blue-500 transition-colors"
                aria-label="WhatsApp"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    to={link.href}
                    className="text-sm hover:text-sanasa-blue-400 transition-colors"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          <div>
            ...
            <address className="not-italic space-y-3 text-sm">
              <div className="flex items-start space-x-3">
                <svg className="w-5 h-5 text-sanasa-blue-500 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-sanasa-blue-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:+94771234567" className="hover:text-sanasa-blue-400">
                  +94 37 229 3845
                </a>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:info@sanasawilbagedara.lk" className="hover:text-sanasa-blue-400">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm">
            ...
            <div className="flex space-x-4 mt-2 md:mt-0">
              <Link to="/privacy" className="hover:text-sanasa-blue-400">
                Privacy Policy
              </Link>
              <Link to="/terms" className="hover:text-sanasa-blue-400">
                Terms of Service
              </Link>
            </div>
          </div>
